...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        self::seedPropietario();
    }

    private static function seedPropietario (){
        Propietario::truncate();
        foreach (self::$arrayPropietarios as $propietario){
            $p = new Propietario();
            $p->idPropietario = $propietario['idPropietario'];
    ...
    private static $arrayPropietarios = array(
